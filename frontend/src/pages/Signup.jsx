    ...
    <>
      <div className="max-w-[70%] md:max-w-[50%] lg:max-w-[30%] mx-auto my-12  ">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className="w-full border-0 outline-none bg-slate-800 text-white font-xl tracking-widest uppercase font-semibold px-8 py-2 rounded-md hover:bg-slate-600">
            Signup
          </button>
        </form>
